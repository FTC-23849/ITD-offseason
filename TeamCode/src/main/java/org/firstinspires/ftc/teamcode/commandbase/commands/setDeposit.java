...
public class setDeposit extends CommandBase {
    ...
    public setDeposit(Robot robot, Deposit.DepositPivotState pivotState, Deposit.DepositTurretState turretState,
    ...
    public void initialize() {
        if (Deposit.depositPivotState.equals(this.pivotState) && Deposit.depositTurretState.equals(this.turretState)
                ...
                && robot.deposit.target == this.target) {
            ...
            // Move slides
            robot.deposit.setOuttakeTarget(target);
